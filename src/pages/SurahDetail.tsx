          ...
          <div className="container mx-auto">
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="w-full md:w-8/12 lg:w-9/12">
                {isLoading ? (
                  <div className="rounded-xl bg-secondary/70 dark:bg-white/5 border border-border p-6 animate-pulse">
                  ...
                  <div className="bg-white/80 dark:bg-black/30 backdrop-blur-sm border border-border rounded-xl overflow-hidden shadow-md">
                    <div className="p-6">
                      <div className="flex items-center justify-between mb-4">
                        <div>
                          ...
                          <p className="text-foreground/70">
                            Surah No. {currentSurah.surahNumber} • {currentSurah.totalAyats} Ayats • {currentSurah.duration}
                          </p>
                        </div>
                        ...
                        {currentSurah.pdfUrl && (
                          <a 
                            ...
                            className="inline-flex items-center px-4 py-2 bg-islamic-navy/10 hover:bg-islamic-navy/20 dark:bg-white/10 dark:hover:bg-white/20 text-islamic-navy dark:text-white rounded-lg transition-colors"
                          >
                      ...
                      <div className="flex items-center justify-center mb-6">
                        <h2 className="text-3xl font-arabic text-islamic-gold" dir="rtl">
                        ...
                        <div className="flex justify-between">
                          {previousSurah ? (
                            ...
                            >
                              ...
                              <span>Previous: Surah {previousSurah.nameEnglish}</span>
                            </Link>
                          ) : (
                            <div></div>
                          )}
                  ...
                  <div className="bg-white/80 dark:bg-black/30 backdrop-blur-sm border border-border rounded-xl p-8 text-center">
                    <h2 className="text-xl font-medium mb-4">Surah not found</h2>
                    <Link 
                      to="/quran"
              ...
              <div className="w-full md:w-4/12 lg:w-3/12">
                <div className="sticky top-20">
                  <h3 className="text-lg font-serif font-semibold mb-4">Suggested Surahs</h3>
                  
                  <div className="space-y-4">
                    {isLoading ? (
                      Array.from({ length: 3 }).map((_, index) => (
                        <div key={index} className="rounded-xl bg-secondary/70 dark:bg-white/5 border border-border h-28 animate-pulse"></div>
                      ))
                      ...
                      suggestedSurahs.map((surah) => (
                        ...
                        >
                          <div className="p-3">
                            ...
                            <p className="text-xs text-foreground/70">{surah.totalAyats} Ayats</p>
                          </div>
                        </Link>
                      ))
                    ) : (
